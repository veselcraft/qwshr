...
abstract class QWshrPresenter extends SimplePresenter
{
    ...
    function onStartup(): void
    {
        ...
        if(!is_null($user)) {
            ...
            $this->template->staticurl = "/assets/packages/static/qwshr/js/";
            $this->template->nodestaticurl = "/assets/packages/static/qwshr/js/node_modules/";
